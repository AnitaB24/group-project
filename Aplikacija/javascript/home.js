...
export let cor = null;
const TEKST = "Dobrodošli na sajt gde ćete uz zanimljive zadatke naučiti nešto više o Vašem programskom jeziku.<br>Mi smo tim mladih inženjera, iz Niša, koji su osmislili ovaj sajt sa ciljem da kroz interaktovne zadatke pomognemo ljudima da uđu u svet programiranja i nauče nove stvari.<br>Takođe, podstičemo takmičarski duh kroz ocenjivanje vašeg znanja.<br>Nadamo se da ćete uz nas steći puno novih znanja i pritom se zabaviti!!!<br>Video upustvo za korišćenje sajta:";
...
function aboutUsBtnFun() {
    ...
    gitMarko.innerHTML = "MarkoBudišaGit";
    ...
    gitNevena.innerHTML = "NevenaBrkićGit";
    ...
    gitAnita.innerHTML = "AnitaBrandićGit";
...
export function approveBtnFun() {
    //pribavljaju se svi zadaci koji cekaju na odobrenje
    let tempDiv = document.body.getElementsByClassName("kontejner-main-body");
    document.body.removeChild(tempDiv.item(0));
...
//     let izborMain = document.createElement("div");
//     izborMain.classList.add("kontejner-main-body");

//     document.body.appendChild(izborMain);

//     dugmad.forEach(dugme => {

//         izborMain.appendChild(dugme);
//     })
// }
function openNav() {
...
//ACATEGORY PONOVITI ZA SVE I ONDA U OPENNAV DA SE DODAJE KOJE NIJE NONE
...
//let slideMenuBtn = document.getElementById("slide-menu-button");
...
//slideMenuBtn.onclick = e => {slideBtnFun()};
